The planet terrain is only the terrain surface extracted by elevation filtering from the original terrain data, which is part of our previous work published in ICRA2021. Refer to
 ```
